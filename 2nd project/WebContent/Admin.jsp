			...
			<div class="inner">
				...
				<div class="row 200%">
					...
					<div class="1u$ 12u$(medium)" style="padding: 0 0 0 12px;">
						<br> <br>
						<ul class="actions">
							<li><a href="#" class="button icon fa-download">다운로드</a></li>
							<br>
							<br>
							<li><a href="#" class="button alt icon fa-check">업 로드</a></li>
	...
	<!-- Text stuff
						...
						<div class="3u$ 12u$(medium)">
							...
							Buttons
								...
								<ul class="actions">
									<li><a href="#" class="button icon fa-download">Icon</a></li>다운로드  아이콘	
								</ul>
